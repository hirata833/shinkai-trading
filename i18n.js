(function () {
  ...
  var dict = {
    ja: {
      ...
      'form.submit': '送信する',
      'form.note': '※ 送信ボタンを押すとメールソフトが起動します。添付ファイルがある場合は、メール作成画面でファイルを添付してから送信してください。',
    ...
    en: {
      ...
      'form.submit': 'Send',
      'form.note': '* Clicking Send opens your email app. If you have attachments, please attach the files in the email composer before sending.',
