(function () {
  ...
  var dict = {
    ja: {
      'logo.header': '信匯商事株式会社',
      'logo.company': '信匯商事株式会社',
      'meta.title': '信匯商事株式会社 | 中古分析機器の買取・販売',
      'meta.description': '信匯商事株式会社は、国内外メーカーの中古分析機器の買取・販売を行う専門商社です。',
      'nav.about': '会社概要',
      'nav.services': '事業内容',
      'nav.brands': '取扱ブランド',
      'nav.flow': 'ご利用の流れ',
      ...
      'stat.area': '対応エリア',
      'about.title': '会社概要',
      'about.lead': '信匯商事株式会社は、理化学分析機器の中古取引を専門とする商社です。研究機関・製薬・化学・食品・環境分析など、幅広い分野で使用される分析機器の買取から販売まで一貫してサポートいたします。',
      ...
      'privacy.metaTitle': 'プライバシーポリシー | 信匯商事株式会社',
      'privacy.back': '← トップページへ戻る',
      'privacy.title': 'プライバシーポリシー',
      'privacy.intro': '信匯商事株式会社（以下「当社」）は、お客様の個人情報の保護を重要な責務と認識し、以下のとおりプライバシーポリシーを定め、適切な取り扱いに努めます。',
    ...
    en: {
      ...
      'company.addressValue': 'Flair Nishiarai Daini, 2-5-3 Nishiarai, Adachi-ku, Tokyo 123-0841, JAPAN',
